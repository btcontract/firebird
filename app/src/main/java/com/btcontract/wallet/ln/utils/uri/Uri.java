package com.btcontract.wallet.ln.utils.uri;
...
public abstract class Uri implements Comparable<Uri> {
    ...
    */
        ...
        do {
            ...
            if (separator - start == encodedKey.length()
                ...
                if (separator == end) {
                    ...
                    return UriCodec.decode(encodedValue, true, Charset.forName("UTF-8"), true);
                }
            }
    ...
    public static String decode(String s) {
        ...
        return UriCodec.decode(s, false, Charset.forName("UTF-8"), true);
    }
