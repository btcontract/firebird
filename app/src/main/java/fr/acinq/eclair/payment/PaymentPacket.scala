...
object IncomingPacket {
  ...
  private def decryptOnion[T <: Onion.PacketType : ClassTag](add: UpdateAddHtlc, privateKey: PrivateKey, features: Features)(packet: OnionRoutingPacket, packetType: Sphinx.OnionRoutingPacket[T]): Either[FailureMessage, DecodedOnionPacket[T]] =
  ...
  /**
    ...
    */
  def decrypt(add: UpdateAddHtlc, privateKey: PrivateKey, features: Features): Either[FailureMessage, IncomingPacket] = {
