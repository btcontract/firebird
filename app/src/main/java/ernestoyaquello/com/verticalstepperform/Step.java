...
public abstract class Step<T> {
    ...
    Boolean forceShowConfirmation;

    private List<InternalFormStepListener> internalListeners;

    protected Step(String title, Boolean forceShowConfirmation) {
        this(title, "", forceShowConfirmation);
    }

    protected Step(String title, String subtitle, Boolean forceShowConfirmation) {
        this(title, subtitle, "", forceShowConfirmation);
    }

    protected Step(String title, String subtitle, String nextButtonText, Boolean forceShowConfirmation) {
        this.title = title;
        this.subtitle = subtitle;
        this.nextButtonText = nextButtonText;
        this.originalNextButtonText = nextButtonText;
        this.errorMessage = "";
        this.forceShowConfirmation = forceShowConfirmation;
